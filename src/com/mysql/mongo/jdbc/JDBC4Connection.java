...
public class JDBC4Connection extends ConnectionImpl implements JDBC4MySQLConnection {
    ...
    public Blob createBlob() {
        return new com.mysql.mongo.jdbc.Blob(getExceptionInterceptor());
    }
    ...
    public Clob createClob() {
        return new com.mysql.mongo.jdbc.Clob(getExceptionInterceptor());
    }
    ...
    public NClob createNClob() {
        return new com.mysql.mongo.jdbc.JDBC4NClob(getExceptionInterceptor());
    }
                ...
                try {
                    try {
                        ...
                        if (sqlEx.getCause() instanceof ClassCastException) {
                            ...
                            this.infoProvider = (JDBC4ClientInfoProvider) Util.getInstance("com.mysql.mongo.jdbc." + getClientInfoProvider(), new Class<?>[0],
