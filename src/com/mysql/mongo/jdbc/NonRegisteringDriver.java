...
public class NonRegisteringDriver implements java.sql.Driver {
    ...
    private static final String REPLICATION_URL_PREFIX = "jdbc:mysql-mongo:replication://";

    private static final String URL_PREFIX = "jdbc:mysql-mongo://";

    private static final String MXJ_URL_PREFIX = "jdbc:mysql-mongo:mxj://";

    public static final String LOADBALANCE_URL_PREFIX = "jdbc:mysql-mongo:loadbalance://";
     ...
     * 
     * <PRE>
     * jdbc:mysql-mongo://host:port/database
     * </PRE>
     * 
     * </p>
     * 
    ...
    public java.sql.Connection connect(String url, Properties info) throws SQLException {
        ...
        try {
            Connection newConn = com.mysql.mongo.jdbc.ConnectionImpl.getInstance(host(props), port(props), props, database(props), url);
    ...
    protected java.sql.Connection connectReplicationConnection(String url, Properties info) throws SQLException {
        ...
        // debugging
        slavesProps.setProperty("com.mysql.mongo.jdbc.ReplicationConnection.isSlave", "true");
