...
import com.mysql.mongo.jdbc.authentication.MysqlClearPasswordPlugin;
import com.mysql.mongo.jdbc.authentication.MysqlNativePasswordPlugin;
import com.mysql.mongo.jdbc.authentication.MysqlOldPasswordPlugin;
...
import com.mysql.mongo.jdbc.util.ReadAheadInputStream;
import com.mysql.mongo.jdbc.util.ResultSetUtil;
...
public class MysqlIO {
    ...
    protected ResultSetImpl getResultSet(StatementImpl callingStatement, long columnCount, int maxRows, int resultSetType, int resultSetConcurrency,
        ...
        if (this.connection.versionMeetsMinimum(5, 0, 2) && this.connection.getUseCursorFetch() && isBinaryEncoded && callingStatement != null
            ...
            ServerPreparedStatement prepStmt = (com.mysql.mongo.jdbc.ServerPreparedStatement) callingStatement;
    ...
    protected final ResultSetImpl readResultsForQueryOrUpdate(StatementImpl callingStatement, int maxRows, int resultSetType, int resultSetConcurrency,
        ...
        if (columnCount == 0) {
            ...
            com.mysql.mongo.jdbc.ResultSetImpl results = getResultSet(callingStatement, columnCount, maxRows, resultSetType, resultSetConcurrency, streamResults,
    ...
    private com.mysql.mongo.jdbc.ResultSetImpl buildResultSetWithRows(StatementImpl callingStatement, String catalog, com.mysql.mongo.jdbc.Field[] fields, RowData rows,
        ...
        switch (resultSetConcurrency) {
            case java.sql.ResultSet.CONCUR_READ_ONLY:
                rs = com.mysql.mongo.jdbc.ResultSetImpl.getInstance(catalog, fields, rows, this.connection, callingStatement, false);
            ...
            case java.sql.ResultSet.CONCUR_UPDATABLE:
                rs = com.mysql.mongo.jdbc.ResultSetImpl.getInstance(catalog, fields, rows, this.connection, callingStatement, true);

                break;

            default:
                return com.mysql.mongo.jdbc.ResultSetImpl.getInstance(catalog, fields, rows, this.connection, callingStatement, false);
        }
    ...
    private com.mysql.mongo.jdbc.ResultSetImpl buildResultSetWithUpdates(StatementImpl callingStatement, Buffer resultPacket) throws SQLException {
        long updateCount = -1;
        long updateID = -1;
        String info = null;
        ...
        ResultSetInternalMethods updateRs = com.mysql.mongo.jdbc.ResultSetImpl.getInstance(updateCount, updateID, this.connection, callingStatement);

        if (info != null) {
            ((com.mysql.mongo.jdbc.ResultSetImpl) updateRs).setServerInfo(info);
        }

        return (com.mysql.mongo.jdbc.ResultSetImpl) updateRs;
    }
