...
public class RowDataDynamic implements RowData {
            ...
            if (conn != null) {
                if (!conn.getClobberStreamingResults() && conn.getNetTimeoutForStreamingResults() > 0) {
                    ...
                    try {
                        ...
                        ((com.mysql.mongo.jdbc.StatementImpl) stmt).executeSimpleNonQuery(conn, "SET net_write_timeout=" + oldValue);
                    } finally {
                        if (stmt != null) {
                            stmt.close();
                        }
    ...
    /**
     * @see com.mysql.mongo.jdbc.RowData#getOwner()
     */
    ...
    /**
     * @see com.mysql.mongo.jdbc.RowData#setOwner(com.mysql.mongo.jdbc.ResultSetInternalMethods)
     */
