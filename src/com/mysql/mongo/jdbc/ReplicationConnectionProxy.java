...
public class ReplicationConnectionProxy extends MultiHostConnectionProxy implements PingTarget {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_REPL_CONNECTION_CTOR = Class.forName("com.mysql.mongo.jdbc.JDBC4ReplicationMySQLConnection")
                        .getConstructor(new Class[] { ReplicationConnectionProxy.class });
                INTERFACES_TO_PROXY = new Class<?>[] { ReplicationConnection.class, Class.forName("com.mysql.mongo.jdbc.JDBC4MySQLConnection") };
