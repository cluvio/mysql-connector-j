...
import com.mysql.mongo.jdbc.exceptions.MySQLDataException;
import com.mysql.mongo.jdbc.exceptions.MySQLIntegrityConstraintViolationException;
import com.mysql.mongo.jdbc.exceptions.MySQLNonTransientConnectionException;
import com.mysql.mongo.jdbc.exceptions.MySQLQueryInterruptedException;
import com.mysql.mongo.jdbc.exceptions.MySQLSyntaxErrorException;
import com.mysql.mongo.jdbc.exceptions.MySQLTransactionRollbackException;
import com.mysql.mongo.jdbc.exceptions.MySQLTransientConnectionException;
...
public class SQLError {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_COMMUNICATIONS_EXCEPTION_CTOR = Class.forName("com.mysql.mongo.jdbc.exceptions.jdbc4.CommunicationsException")
                ...
                if (sqlState.startsWith("08")) {
                    if (isTransient) {
                        if (!Util.isJdbc4()) {
                            ...
                            sqlEx = (SQLException) Util.getInstance("com.mysql.mongo.jdbc.exceptions.jdbc4.MySQLTransientConnectionException",
                        ...
                        sqlEx = (SQLException) Util.getInstance("com.mysql.mongo.jdbc.exceptions.jdbc4.MySQLNonTransientConnectionException",
                    ...
                    if (!Util.isJdbc4()) {
                        ...
                        sqlEx = (SQLException) Util.getInstance("com.mysql.mongo.jdbc.exceptions.jdbc4.MySQLDataException",
                                new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) },
                                interceptor);
                    }
                    ...
                    if (!Util.isJdbc4()) {
                        ...
                        sqlEx = (SQLException) Util.getInstance("com.mysql.mongo.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException",
                                new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) },
                                interceptor);
                    }
                    ...
                    if (!Util.isJdbc4()) {
                        ...
                        sqlEx = (SQLException) Util.getInstance("com.mysql.mongo.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException",
                                new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) },
                                interceptor);
                    }
                    ...
                    if (!Util.isJdbc4()) {
                        ...
                        sqlEx = (SQLException) Util.getInstance("com.mysql.mongo.jdbc.exceptions.jdbc4.MySQLTransactionRollbackException",
                                new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) },
                                interceptor);
                    }
                    ...
                    if (!Util.isJdbc4()) {
                        ...
                        sqlEx = (SQLException) Util.getInstance("com.mysql.mongo.jdbc.exceptions.jdbc4.MySQLQueryInterruptedException",
                                new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) },
                                interceptor);
                    }
                } else {
