...
public class CallableStatement extends PreparedStatement implements java.sql.CallableStatement {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                String jdbc4ClassName = Util.isJdbc42() ? "com.mysql.mongo.jdbc.JDBC42CallableStatement" : "com.mysql.mongo.jdbc.JDBC4CallableStatement";
    ...
    private final static String PARAMETER_NAMESPACE_PREFIX = "@com.mysql.mongo.jdbc_outparam_";
            ...
            if (numParameters > 0) {
                ...
                if (hadOutputParams) {
                    ...
                    try {
                        ...
                        this.outputParameterResults = ((com.mysql.mongo.jdbc.ResultSetInternalMethods) outParamRs).copy();
