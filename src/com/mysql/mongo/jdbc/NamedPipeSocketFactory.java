...
public class NamedPipeSocketFactory implements SocketFactory, SocketMetadata {
    ...
    /**
     * @see com.mysql.mongo.jdbc.SocketFactory#afterHandshake()
     */
    ...
    /**
     * @see com.mysql.mongo.jdbc.SocketFactory#beforeHandshake()
     */
    ...
    /**
     * @see com.mysql.mongo.jdbc.SocketFactory#connect(String, Properties)
     */
