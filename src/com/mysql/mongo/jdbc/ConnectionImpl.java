...
import com.mysql.mongo.jdbc.PreparedStatement.ParseInfo;
import com.mysql.mongo.jdbc.log.Log;
import com.mysql.mongo.jdbc.log.LogFactory;
import com.mysql.mongo.jdbc.log.NullLogger;
import com.mysql.mongo.jdbc.profiler.ProfilerEvent;
import com.mysql.mongo.jdbc.profiler.ProfilerEventHandler;
import com.mysql.mongo.jdbc.util.LRUCache;
...
public class ConnectionImpl extends ConnectionPropertiesImpl implements MySQLConnection {
    ...
    protected static final String DEFAULT_LOGGER_CLASS = "com.mysql.mongo.jdbc.log.StandardLogger";
    ...
    static {
        ...
        if (Util.isJdbc4()) {
            try {
                JDBC_4_CONNECTION_CTOR = Class.forName("com.mysql.mongo.jdbc.JDBC4Connection")
    ...
    public java.sql.PreparedStatement clientPrepareStatement(String sql, int autoGenKeyIndex) throws SQLException {
        ...
        ((com.mysql.mongo.jdbc.PreparedStatement) pStmt).setRetrieveGeneratedKeys(autoGenKeyIndex == java.sql.Statement.RETURN_GENERATED_KEYS);
    ...
    public java.sql.PreparedStatement clientPrepareStatement(String sql, int resultSetType, int resultSetConcurrency, boolean processEscapeCodesIfNeeded)
        ...
        if (getCachePreparedStatements()) {
            ...
            if (pStmtInfo == null) {
                pStmt = com.mysql.mongo.jdbc.PreparedStatement.getInstance(getMultiHostSafeProxy(), nativeSql, this.database);

                this.cachedPreparedStatementParams.put(nativeSql, pStmt.getParseInfo());
            } else {
                pStmt = com.mysql.mongo.jdbc.PreparedStatement.getInstance(getMultiHostSafeProxy(), nativeSql, this.database, pStmtInfo);
            }
        } else {
            pStmt = com.mysql.mongo.jdbc.PreparedStatement.getInstance(getMultiHostSafeProxy(), nativeSql, this.database);
        }
        ...
        try {
            if (versionMeetsMinimum(4, 1, 0)) {
                ...
                try {
                    ...
                    if (this.props != null && this.props.getProperty("com.mysql.mongo.jdbc.faultInjection.serverCharsetIndex") != null) {
                        this.io.serverCharsetIndex = Integer.parseInt(this.props.getProperty("com.mysql.mongo.jdbc.faultInjection.serverCharsetIndex"));
                    }
    ...
    private java.sql.DatabaseMetaData getMetaData(boolean checkClosed, boolean checkForInfoSchema) throws SQLException {
        ...
        return com.mysql.mongo.jdbc.DatabaseMetaData.getInstance(getMultiHostSafeProxy(), this.database, checkForInfoSchema);
    }
    ...
    private void initializeDriverProperties(Properties info) throws SQLException {
        ...
        if (getSocksProxyHost() != null) {
            setSocketFactoryClassName("com.mysql.mongo.jdbc.SocksProxySocketFactory");
        }
    }
    ...
    public java.sql.CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        ...
        CallableStatement cStmt = (com.mysql.mongo.jdbc.CallableStatement) prepareCall(sql, resultSetType, resultSetConcurrency);
            ...
            if (this.useServerPreparedStmts && canServerPrepare) {
                if (this.getCachePreparedStatements()) {
                    synchronized (this.serverSideStatementCache) {
                        ...
                        if (pStmt != null) {
                            ((com.mysql.mongo.jdbc.ServerPreparedStatement) pStmt).setClosed(false);
                        ...
                        if (pStmt == null) {
                            try {
                                ...
                                if (sql.length() < getPreparedStatementCacheSqlLimit()) {
                                    ((com.mysql.mongo.jdbc.ServerPreparedStatement) pStmt).isCached = true;
                                }
    ...
    public java.sql.PreparedStatement prepareStatement(String sql, int[] autoGenKeyIndexes) throws SQLException {
        ...
        ((com.mysql.mongo.jdbc.PreparedStatement) pStmt).setRetrieveGeneratedKeys((autoGenKeyIndexes != null) && (autoGenKeyIndexes.length > 0));
    ...
    public java.sql.PreparedStatement prepareStatement(String sql, String[] autoGenKeyColNames) throws SQLException {
        ...
        ((com.mysql.mongo.jdbc.PreparedStatement) pStmt).setRetrieveGeneratedKeys((autoGenKeyColNames != null) && (autoGenKeyColNames.length > 0));
