...
public class MysqlDataSource extends ConnectionPropertiesImpl implements DataSource, Referenceable, Serializable {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Can not load Driver class com.mysql.mongo.jdbc.Driver");
        }
    }
    ...
    public Reference getReference() throws NamingException {
        String factoryName = "com.mysql.mongo.jdbc.jdbc2.optional.MysqlDataSourceFactory";
    ...
    public String getUrl() {
        if (!this.explicitUrl) {
            String builtUrl = "jdbc:mysql-mongo://";
    ...
    protected java.sql.Connection getConnection(Properties props) throws SQLException {
        ...
        if (!this.explicitUrl) {
            StringBuilder jdbcUrl = new StringBuilder("jdbc:mysql-mongo://");
