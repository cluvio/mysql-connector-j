...
public class StatementWrapper extends WrapperBase implements Statement {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_STATEMENT_WRAPPER_CTOR = Class.forName("com.mysql.mongo.jdbc.jdbc2.optional.JDBC4StatementWrapper")
    ...
    public void enableStreamingResults() throws SQLException {
        try {
            if (this.wrappedStmt != null) {
                ((com.mysql.mongo.jdbc.Statement) this.wrappedStmt).enableStreamingResults();
            } else {
