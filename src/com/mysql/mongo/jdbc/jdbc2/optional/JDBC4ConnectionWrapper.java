...
public class JDBC4ConnectionWrapper extends ConnectionWrapper {
     ...
     *             if an error occurs.
     */
    public JDBC4ConnectionWrapper(MysqlPooledConnection mysqlPooledConnection, com.mysql.mongo.jdbc.Connection mysqlConnection, boolean forXa) throws SQLException {
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        return (iface.getName().equals("com.mysql.mongo.jdbc.Connection") || iface.getName().equals("com.mysql.mongo.jdbc.ConnectionProperties"));
    }
