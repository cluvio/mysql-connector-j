...
public class ConnectionWrapper extends WrapperBase implements Connection {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_CONNECTION_WRAPPER_CTOR = Class.forName("com.mysql.mongo.jdbc.jdbc2.optional.JDBC4ConnectionWrapper")
    ...
    public boolean isSameResource(com.mysql.mongo.jdbc.Connection c) {
