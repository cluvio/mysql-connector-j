...
public class CallableStatementWrapper extends PreparedStatementWrapper implements CallableStatement {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                String jdbc4ClassName = Util.isJdbc42() ? "com.mysql.mongo.jdbc.jdbc2.optional.JDBC42CallableStatementWrapper"
                        : "com.mysql.mongo.jdbc.jdbc2.optional.JDBC4CallableStatementWrapper";
