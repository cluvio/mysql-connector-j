...
public class MysqlPooledConnection implements PooledConnection {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_POOLED_CONNECTION_WRAPPER_CTOR = Class.forName("com.mysql.mongo.jdbc.jdbc2.optional.JDBC4MysqlPooledConnection")
                        .getConstructor(new Class[] { com.mysql.mongo.jdbc.Connection.class });
    ...
    protected static MysqlPooledConnection getInstance(com.mysql.mongo.jdbc.Connection connection) throws SQLException {
        if (!Util.isJdbc4()) {
    ...
    private com.mysql.mongo.jdbc.Connection physicalConn;
     ...
     */
    public MysqlPooledConnection(com.mysql.mongo.jdbc.Connection connection) {
