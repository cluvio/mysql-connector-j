...
public class PreparedStatementWrapper extends StatementWrapper implements PreparedStatement {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                String jdbc4ClassName = Util.isJdbc42() ? "com.mysql.mongo.jdbc.jdbc2.optional.JDBC42PreparedStatementWrapper"
                        : "com.mysql.mongo.jdbc.jdbc2.optional.JDBC4PreparedStatementWrapper";
    ...
    public String toString() {
        ...
        if (this.wrappedStmt != null) {
            buf.append(": ");
            try {
                buf.append(((com.mysql.mongo.jdbc.PreparedStatement) this.wrappedStmt).asSql());
            } catch (SQLException sqlEx) {
    ...
    public long executeLargeUpdate() throws SQLException {
        try {
            if (this.wrappedStmt != null) {
                return ((com.mysql.mongo.jdbc.PreparedStatement) this.wrappedStmt).executeLargeUpdate();
            }
