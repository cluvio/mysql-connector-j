...
public class JDBC4CallableStatement extends CallableStatement {
    ...
    public SQLXML getSQLXML(int parameterIndex) throws SQLException {
        ...
        SQLXML retValue = ((com.mysql.mongo.jdbc.JDBC4ResultSet) rs).getSQLXML(mapOutputParameterIndexToRsIndex(parameterIndex));
    ...
    public SQLXML getSQLXML(String parameterName) throws SQLException {
        ...
        SQLXML retValue = ((com.mysql.mongo.jdbc.JDBC4ResultSet) rs).getSQLXML(fixParameterName(parameterName));
    ...
    public RowId getRowId(int parameterIndex) throws SQLException {
        ...
        RowId retValue = ((com.mysql.mongo.jdbc.JDBC4ResultSet) rs).getRowId(mapOutputParameterIndexToRsIndex(parameterIndex));
    ...
    public RowId getRowId(String parameterName) throws SQLException {
        ...
        RowId retValue = ((com.mysql.mongo.jdbc.JDBC4ResultSet) rs).getRowId(fixParameterName(parameterName));
    ...
    public Reader getNCharacterStream(int parameterIndex) throws SQLException {
        ...
        Reader retValue = ((com.mysql.mongo.jdbc.JDBC4ResultSet) rs).getNCharacterStream(mapOutputParameterIndexToRsIndex(parameterIndex));
    ...
    public Reader getNCharacterStream(String parameterName) throws SQLException {
        ...
        Reader retValue = ((com.mysql.mongo.jdbc.JDBC4ResultSet) rs).getNCharacterStream(fixParameterName(parameterName));
    ...
    public NClob getNClob(int parameterIndex) throws SQLException {
        ...
        NClob retValue = ((com.mysql.mongo.jdbc.JDBC4ResultSet) rs).getNClob(mapOutputParameterIndexToRsIndex(parameterIndex));
    ...
    public NClob getNClob(String parameterName) throws SQLException {
        ...
        NClob retValue = ((com.mysql.mongo.jdbc.JDBC4ResultSet) rs).getNClob(fixParameterName(parameterName));
    ...
    public String getNString(int parameterIndex) throws SQLException {
        ...
        String retValue = ((com.mysql.mongo.jdbc.JDBC4ResultSet) rs).getNString(mapOutputParameterIndexToRsIndex(parameterIndex));
    ...
    public String getNString(String parameterName) throws SQLException {
        ...
        String retValue = ((com.mysql.mongo.jdbc.JDBC4ResultSet) rs).getNString(fixParameterName(parameterName));
