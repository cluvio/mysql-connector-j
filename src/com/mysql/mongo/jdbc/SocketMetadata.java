...
public interface SocketMetadata {
    ...
    static class Helper {
        ...
        public static final String IS_LOCAL_HOSTNAME_REPLACEMENT_PROPERTY_NAME = "com.mysql.mongo.jdbc.test.isLocalHostnameReplacement";

        public static boolean isLocallyConnected(com.mysql.mongo.jdbc.ConnectionImpl conn) throws SQLException {
