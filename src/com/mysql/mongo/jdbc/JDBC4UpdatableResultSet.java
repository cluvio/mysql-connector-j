...
import com.mysql.mongo.jdbc.RowData;
import com.mysql.mongo.jdbc.Statement;
import com.mysql.mongo.jdbc.StringUtils;
import com.mysql.mongo.jdbc.UpdatableResultSet;
...
public class JDBC4UpdatableResultSet extends UpdatableResultSet {
    ...
    public void updateNCharacterStream(int columnIndex, java.io.Reader x, int length) throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            if (!this.onInsertRow) {
                ...
                ((com.mysql.mongo.jdbc.JDBC4PreparedStatement) this.updater).setNCharacterStream(columnIndex, x, length);
            } else {
                ((com.mysql.mongo.jdbc.JDBC4PreparedStatement) this.inserter).setNCharacterStream(columnIndex, x, length);
    ...
    public void updateNString(int columnIndex, String x) throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            if (!this.onInsertRow) {
                ...
                ((com.mysql.mongo.jdbc.JDBC4PreparedStatement) this.updater).setNString(columnIndex, x);
            } else {
                ((com.mysql.mongo.jdbc.JDBC4PreparedStatement) this.inserter).setNString(columnIndex, x);
    ...
    public NClob getNClob(int columnIndex) throws SQLException {
        ...
        if (!this.isBinaryEncoded) {
            ...
            return new com.mysql.mongo.jdbc.JDBC4NClob(asString, getExceptionInterceptor());
        }
    ...
    private final java.sql.NClob getNClobFromString(String stringVal, int columnIndex) throws SQLException {
        return new com.mysql.mongo.jdbc.JDBC4NClob(stringVal, getExceptionInterceptor());
    }
