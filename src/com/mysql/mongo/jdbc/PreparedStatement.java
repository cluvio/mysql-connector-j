 ...
 * </p>
 */
public class PreparedStatement extends com.mysql.mongo.jdbc.StatementImpl implements java.sql.PreparedStatement {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                String jdbc4ClassName = Util.isJdbc42() ? "com.mysql.mongo.jdbc.JDBC42PreparedStatement" : "com.mysql.mongo.jdbc.JDBC4PreparedStatement";
        ...
        for (int j = 0; j < isNullBatch.length; j++) {
            if (isNullBatch[j]) {
                ...
                if (isStreamBatch[j]) {
                    ...
                    ((com.mysql.mongo.jdbc.PreparedStatement) batchedStatement).setBytesNoEscapeNoQuotes(batchedParamIndex++, paramArg.parameterStrings[j]);
                }
            }
        }
