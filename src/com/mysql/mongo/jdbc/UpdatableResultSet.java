...
public class UpdatableResultSet extends ResultSetImpl {
    ...
    private com.mysql.mongo.jdbc.PreparedStatement deleter = null;
    ...
    protected com.mysql.mongo.jdbc.PreparedStatement inserter = null;
    ...
    private com.mysql.mongo.jdbc.PreparedStatement refresher;
    ...
    /** PreparedStatement used to delete data */
    protected com.mysql.mongo.jdbc.PreparedStatement updater = null;
     ...
     * (non-Javadoc)
     * 
     * @see com.mysql.mongo.jdbc.ResultSet#checkRowPos()
     */
    @Override
