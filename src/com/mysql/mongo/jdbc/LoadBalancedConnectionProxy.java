...
/**
 * A proxy for a dynamic com.mysql.mongo.jdbc.Connection implementation that load balances requests across a series of MySQL JDBC connections, where the balancing
...
public class LoadBalancedConnectionProxy extends MultiHostConnectionProxy implements PingTarget {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_LB_CONNECTION_CTOR = Class.forName("com.mysql.mongo.jdbc.JDBC4LoadBalancedMySQLConnection")
                        .getConstructor(new Class<?>[] { LoadBalancedConnectionProxy.class });
                INTERFACES_TO_PROXY = new Class<?>[] { LoadBalancedConnection.class, Class.forName("com.mysql.mongo.jdbc.JDBC4MySQLConnection") };
    ...
    private LoadBalancedConnectionProxy(List<String> hosts, Properties props) throws SQLException {
        ...
        if (this.autoCommitSwapThreshold > 0) {
            ...
            if (statementInterceptors == null) {
                this.localProps.setProperty("statementInterceptors", "com.mysql.mongo.jdbc.LoadBalancedAutoCommitInterceptor");
            } else if (statementInterceptors.length() > 0) {
                this.localProps.setProperty("statementInterceptors", statementInterceptors + ",com.mysql.mongo.jdbc.LoadBalancedAutoCommitInterceptor");
            }
        ...
        String lbExceptionChecker = this.localProps.getProperty("loadBalanceExceptionChecker", "com.mysql.mongo.jdbc.StandardLoadBalanceExceptionChecker");
    ...
    public synchronized Object invokeMore(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        try {
            ...
            if (result != null) {
                if (result instanceof com.mysql.mongo.jdbc.Statement) {
                    ((com.mysql.mongo.jdbc.Statement) result).setPingTarget(this);
                }
