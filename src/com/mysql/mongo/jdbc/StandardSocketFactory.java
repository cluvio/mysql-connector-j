...
public class StandardSocketFactory implements SocketFactory, SocketMetadata {
    ...
    /**
     * @see com.mysql.mongo.jdbc.SocketFactory#createSocket(Properties)
     */
    ...
    public boolean isLocallyConnected(com.mysql.mongo.jdbc.ConnectionImpl conn) throws SQLException {
