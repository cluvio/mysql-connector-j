...
public class DatabaseMetaDataUsingInfoSchema extends DatabaseMetaData {
    ...
    protected ResultSet executeMetadataQuery(java.sql.PreparedStatement pStmt) throws SQLException {
        ...
        ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).setOwningStatement(null);
    ...
    public java.sql.ResultSet getColumnPrivileges(String catalog, String schema, String table, String columnNamePattern) throws SQLException {
        ...
        try {
            ...
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).redefineFieldsForDBMD(new Field[] { new Field("", "TABLE_CAT", Types.CHAR, 64),
    ...
    public ResultSet getColumns(String catalog, String schemaPattern, String tableName, String columnNamePattern) throws SQLException {
        ...
        try {
            ...
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).redefineFieldsForDBMD(createColumnsFields());
            return rs;
        } finally {
            if (pStmt != null) {
                pStmt.close();
    ...
    public java.sql.ResultSet getCrossReference(String primaryCatalog, String primarySchema, String primaryTable, String foreignCatalog, String foreignSchema,
        ...
        try {
            ...
            ResultSet rs = executeMetadataQuery(pStmt);
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).redefineFieldsForDBMD(createFkMetadataFields());
    ...
    public ResultSet getIndexInfo(String catalog, String schema, String table, boolean unique, boolean approximate) throws SQLException {
        ...
        try {
            ...
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).redefineFieldsForDBMD(createIndexInfoFields());
    ...
    public java.sql.ResultSet getPrimaryKeys(String catalog, String schema, String table) throws SQLException {
        ...
        try {
            ...
            ResultSet rs = executeMetadataQuery(pStmt);
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).redefineFieldsForDBMD(new Field[] { new Field("", "TABLE_CAT", Types.CHAR, 255),
    ...
    public ResultSet getProcedures(String catalog, String schemaPattern, String procedureNamePattern) throws SQLException {
        ...
        try {
            ...
            ResultSet rs = executeMetadataQuery(pStmt);
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).redefineFieldsForDBMD(createFieldMetadataForGetProcedures());
    ...
    public ResultSet getProcedureColumns(String catalog, String schemaPattern, String procedureNamePattern, String columnNamePattern) throws SQLException {
        ...
        try {
            ...
            ResultSet rs = executeMetadataQuery(pStmt);
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).redefineFieldsForDBMD(createProcedureColumnsFields());
    ...
    public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern, String[] types) throws SQLException {
        ...
        try {
            ...
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).redefineFieldsForDBMD(createTablesFields());
    ...
    public ResultSet getVersionColumns(String catalog, String schema, String table) throws SQLException {
        ...
        try {
            ...
            ResultSet rs = executeMetadataQuery(pStmt);
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).redefineFieldsForDBMD(new Field[] { new Field("", "SCOPE", Types.SMALLINT, 5),
    ...
    public ResultSet getFunctionColumns(String catalog, String schemaPattern, String functionNamePattern, String columnNamePattern) throws SQLException {
        ...
        try {
            ...
            ResultSet rs = executeMetadataQuery(pStmt);
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs).redefineFieldsForDBMD(createFunctionColumnsFields());
    ...
    public java.sql.ResultSet getFunctions(String catalog, String schemaPattern, String functionNamePattern) throws SQLException {
        ...
        try {
            ...
            ResultSet rs = executeMetadataQuery(pStmt);
            ((com.mysql.mongo.jdbc.ResultSetInternalMethods) rs)
