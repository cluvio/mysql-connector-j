...
public class LogUtils {
    ...
    public static String findCallingClassAndMethod(Throwable t) {
        ...
        int endInternalMethods = stackTraceAsString.lastIndexOf("com.mysql.mongo.jdbc");

        if (endInternalMethods != -1) {
            int endOfLine = -1;
            int compliancePackage = stackTraceAsString.indexOf("com.mysql.mongo.jdbc.compliance", endInternalMethods);
