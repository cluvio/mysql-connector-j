...
/**
 * A proxy for a dynamic com.mysql.mongo.jdbc.Connection implementation that provides failover features for list of hosts. Connection switching occurs on
...
public class FailoverConnectionProxy extends MultiHostConnectionProxy {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                INTERFACES_TO_PROXY = new Class<?>[] { Class.forName("com.mysql.mongo.jdbc.JDBC4MySQLConnection") };
     ...
     * 
     * @see com.mysql.mongo.jdbc.MultiHostConnectionProxy#getNewJdbcInterfaceProxy(java.lang.Object)
     */
    @Override
     ...
     * 
     * @see com.mysql.mongo.jdbc.MultiHostConnectionProxy#shouldExceptionTriggerConnectionSwitch(java.lang.Throwable)
     */
    @Override
     ...
     * 
     * @see com.mysql.mongo.jdbc.MultiHostConnectionProxy#pickNewConnection()
     */
    @Override
