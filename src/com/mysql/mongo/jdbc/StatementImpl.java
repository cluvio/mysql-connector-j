...
public class StatementImpl implements Statement {
    ...
    private ResultSetInternalMethods createResultSetUsingServerFetch(String sql) throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            rs.setStatementUsedForFetchingRows((com.mysql.mongo.jdbc.PreparedStatement) pStmt);
     ...
     * (non-Javadoc)
     * 
     * @see com.mysql.mongo.jdbc.IStatement#enableStreamingResults()
     */
    ...
    public java.sql.ResultSet getGeneratedKeys() throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            this.generatedKeysResults = com.mysql.mongo.jdbc.ResultSetImpl.getInstance(this.currentCatalog, fields, new RowDataStatic(this.batchedGeneratedKeys),
    ...
    protected ResultSetInternalMethods getGeneratedKeysInternal(long numKeys) throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            com.mysql.mongo.jdbc.ResultSetImpl gkRs = com.mysql.mongo.jdbc.ResultSetImpl.getInstance(this.currentCatalog, fields, new RowDataStatic(rowSet),
                    this.connection, this, false);
