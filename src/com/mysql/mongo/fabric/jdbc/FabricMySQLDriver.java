...
public class FabricMySQLDriver extends NonRegisteringDriver implements Driver {
    ...
    public static final String FABRIC_URL_PREFIX = "jdbc:mysql-mongo:fabric://";
    ...
    public Connection connect(String url, Properties info) throws SQLException {
        ...
        if (com.mysql.mongo.jdbc.Util.isJdbc4()) {
            try {
                Constructor<?> jdbc4proxy = Class.forName("com.mysql.mongo.fabric.jdbc.JDBC4FabricMySQLConnectionProxy")
                        .getConstructor(new Class[] { Properties.class });
                return (Connection) com.mysql.mongo.jdbc.Util.handleNewInstance(jdbc4proxy, new Object[] { parsedProps }, null);
            } catch (Exception e) {
    ...
    /* static */Properties parseFabricURL(String url, Properties defaults) throws SQLException {
        if (!url.startsWith("jdbc:mysql-mongo:fabric://")) {
            return null;
        }
