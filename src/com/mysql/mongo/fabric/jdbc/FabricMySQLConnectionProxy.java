...
package com.mysql.mongo.fabric.jdbc;
...
import com.mysql.mongo.jdbc.ConnectionPropertiesImpl;
...
import com.mysql.mongo.jdbc.SingleByteCharsetConverter;
...
public class FabricMySQLConnectionProxy extends ConnectionPropertiesImpl implements FabricMySQLConnection, FabricMySQLConnectionProperties {
    ...
    static {
        ...
        try {
            if (Util.isJdbc4()) {
                clazz = Class.forName("com.mysql.mongo.jdbc.exceptions.jdbc4.MySQLNonTransientConnectionException");
            }
    ...
    public FabricMySQLConnectionProxy(Properties props) throws SQLException {
        ...
        exceptionInterceptors += "com.mysql.mongo.fabric.jdbc.ErrorReportingExceptionInterceptor";
    ...
    // com.mysql.mongo.jdbc.Connection
     ...
     * @param stmt
     */
    public void maxRowsChanged(com.mysql.mongo.jdbc.Statement stmt) {
    }
    ...
    public void registerStatement(com.mysql.mongo.jdbc.Statement stmt) {
    }
    ...
    public void unregisterStatement(com.mysql.mongo.jdbc.Statement stmt) {
    }
     ...
     * @throws SQLException
     */
    public void unsetMaxRows(com.mysql.mongo.jdbc.Statement stmt) throws SQLException {
    }
